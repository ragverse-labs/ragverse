...
# import requests
# from app.api.api_v1.endpoints.books import read_all_books
# from app.api.api_v1.endpoints.languages import get_languages
import asyncio
import json
...
class ModelData(metaclass=SingletonMeta):
    ...
    def __init__(self):
        ...
        # print(f"ModelData instance created at {id(self)}")
