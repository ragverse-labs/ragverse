...
#     # sc = ServiceContext.from_defaults(embed_model=settings.membed_model) ̰
...
# # # cs = MilvusClient(URL)
# # query_engine = create_milrun_index("bhagvad_gita")

# # query_engine = create_milrun_index("rig_veda")
# query_engine = query_milrun_index("bhagvad_gita")
# # question1="Explain background on Kunti illegit son"
# # question1="What is biggest mistake of Ram's Father"
...
# question="What are 5 key points in the text? name the book also"
...
# # question1="What is ironical in the description of Krishna's character?"
