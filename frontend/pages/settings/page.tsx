...
import ValidateEmailButton from "@/components/profile/ValidateEmailButton";
...
const navigation = [
  { name: "Account", id: "ACCOUNT", icon: IconUserCircle },
  { name: "Security", id: "SECURITY", icon: IconKey },
];
